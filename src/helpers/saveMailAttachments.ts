...
export function saveMailAttachments(filename: RegExp, downloadsinceDate: string) : Promise<string[]> {
  return new Promise(function (resolve, reject){
    ...
    try {
      ...
      downloadEmailAttachments({
        ...
        timeout: 10000,
        log: {warn: console.warn, debug: doNothing, error: console.error, info: console.info },
